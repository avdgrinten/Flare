...
public class CompilerHelper {
	...
	public boolean compile(String source) {
		...
		resolver.addBuiltin(new Bool.BoolLit(false));
		resolver.addBuiltin(new Bool.BoolLit(true));
		resolver.addBuiltin(Bool.boolNot);
		resolver.addBuiltin(Bool.boolEq);
		resolver.addBuiltin(Bool.boolInEq);
		...
		resolver.addBuiltin(DoubleArithmetic.doubleType);
		resolver.addBuiltin(DoubleArithmetic.doubleAdd);
		resolver.addBuiltin(DoubleArithmetic.doubleSub);
		resolver.addBuiltin(DoubleArithmetic.doubleMul);
		resolver.addBuiltin(DoubleArithmetic.doubleDiv);
		resolver.addBuiltin(DoubleArithmetic.doubleEq);
		resolver.addBuiltin(DoubleArithmetic.doubleLt);
		resolver.addBuiltin(DoubleArithmetic.doubleGt);
		resolver.addBuiltin(DoubleArithmetic.doubleLe);
		resolver.addBuiltin(DoubleArithmetic.doubleGe);
		resolver.addBuiltin(Strings.stringType);
		resolver.addBuiltin(Strings.strEq);
		resolver.addBuiltin(Strings.strCmp);
		resolver.addBuiltin(Strings.strConcat);
		resolver.addBuiltin(Strings.strLen);
		resolver.addBuiltin(Strings.strEmpty);
		resolver.addBuiltin(Strings.strTrim);
		resolver.addBuiltin(Strings.strContains);
		resolver.addBuiltin(Strings.strTl);
		resolver.addBuiltin(Strings.strTu);
		resolver.addBuiltin(Strings.strSub);
